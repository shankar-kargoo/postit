...
7. Other helpful heroku commands:
  ...
  - heroku run console
  - heroku help
heroku url: http://postit-shankar.herokuapp.com/
http://postit-shankar.herokuapp.com
ActiveRecord::DuplicateMigrationVersionError: Multiple migrations have the version number 20140912180423
==